...
.. math::
   ...
   & \sum_r \sum_t \left [ \beta_m^t \Delta t \times \sum_{zsvd} \sum_{lll} \left \{ zsvd....rrlllttt \times \epsilon_{zsvd} \times ccur(zsvd,t) + \right. \right. \\
   ...
   & \beta_b^t \Delta(t-1) { \sum_{zsvd} \sum_{\tau=t}^{t+t_d} \left { yzsvd...rr...\tau \times ccap(svd,\tau) \times fri_{zsvd}^{t_d-\tau} + \right. \\
